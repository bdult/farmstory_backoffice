...
<div class="main-content">
	...
	<div class="page-content">
		...
		<form id="createForm" action="${ contextPath }/contents/create.do" class="form-horizontal" role="form" method="POST">
			<div class="row-fluid">
				...
				<div class="form-group row-fluid">
					...
					<div class="span9">
						...
						<a id="movie-mod-btn" class="btn">Seaching..</a>
			...
			<div id="boxLOC001" >
				...
				<div class="form-group row-fluid">
					...
					<div class="span9">
						...
						<input type="text" id="contents_nm" name="contents_nm" placeholder="Contents Title" class="input-xxlarge" value="${ detailMap.LOC001.CONTENTS_NM }">
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group row-fluid">
			...
			<div id="boxLOC002" >
				...
				<div class="form-group row-fluid">
					...
					<div class="span9">
						...
						<input type="text" id="contents_nm" name="contents_nm" placeholder="Contents Title" class="input-xxlarge" value="${ detailMap.LOC002.CONTENTS_NM }">
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group row-fluid">
			...
			<div id="boxLOC003" >
				...
				<div class="form-group row-fluid">
					<label class="span3 control-label no-padding-right" for="form-field-1">Title</label>
					<div class="span9">
						<input type="text" id="contents_nm" name="contents_nm" placeholder="Contents Title" class="input-xxlarge" value="${ detailMap.LOC003.CONTENTS_NM }">
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group row-fluid">
			...
			<div id="boxLOC004" >
				...
				<div class="form-group row-fluid">
					<label class="span3 control-label no-padding-right" for="form-field-1">Title</label>
					<div class="span9">
						<input type="text" id="contents_nm" name="contents_nm" placeholder="Contents Title" class="input-xxlarge" value="${ detailMap.LOC004.CONTENTS_NM }">
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group row-fluid">
			...
			<div id="boxLOC005" >
				...
				<div class="form-group row-fluid">
					<label class="span3 control-label no-padding-right" for="form-field-1">Title</label>
					<div class="span9">
						<input type="text" id="contents_nm" name="contents_nm" placeholder="Contents Title" class="input-xxlarge" value="${ detailMap.LOC005.CONTENTS_NM }">
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group row-fluid">
			...
			<div id="boxLOC006" >
				...
				<div class="form-group row-fluid">
					<label class="span3 control-label no-padding-right" for="form-field-1">Title</label>
					<div class="span9">
						<input type="text" id="contents_nm" name="contents_nm" placeholder="Contents Title" class="input-xxlarge" value="${ detailMap.LOC006.CONTENTS_NM }">
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group row-fluid">
			...
			<div id="boxLOC007" >
				...
				<div class="form-group row-fluid">
					<label class="span3 control-label no-padding-right" for="form-field-1">Title</label>
					<div class="span9">
						<input type="text" id="contents_nm" name="contents_nm" placeholder="Contents Title" class="input-xxlarge" value="${ detailMap.LOC007.CONTENTS_NM }">
					</div>
				</div>
				<div class="space-4"></div>
				<div class="form-group row-fluid">
		...
		<div class="row-fluid text-center">
			<a id="createBtn" class="btn">Save</a>
