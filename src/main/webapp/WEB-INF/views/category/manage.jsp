...
<div id="creat-cate-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form action="/storyfarm-admin/cate/create.do" method="post">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			<h3 class="text-center">카테고리 등록</h3>
		</div>
		<div class="modal-body">
				카테고리 명  <input type="text" name="brand_nm">
		</div>
